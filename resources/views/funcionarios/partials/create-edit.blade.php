<div class="col-lg-5 col-md-5 col-sm-6">
    ...
    <div class="white-box text-center"><img src="{{$user->foto_url ? asset('storage/fotos/' . $user->foto_url) : asset('img/default_img.png') }}" style="width:100%" class="img-responsive"></div>
